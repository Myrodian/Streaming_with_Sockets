...
print('Esperando conexão em:',socket_address)
...
def video_stream():
    ...
    while True:
        ...
        print('Conexão estabelecida com:',client_addr)
        WIDTH=400
        ...
        while(True):
            ...
            cv2.imshow('Video transmitindo', frame)
...
def audio_stream():
    ...
    p = pyaudio.PyAudio()
    print('Servidor esperando conexão em:',(host_ip, (port-1)))
